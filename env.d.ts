/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv env.d.ts` (hash: c30607330a4cded990af43c0f74c0c9f)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	AI: Ai;
	ASSETS: Fetcher;
	GoalCoachV2: DurableObjectNamespace<import("./custom-worker").GoalCoachV2>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "GoalCoachV2";
	}
